...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-blue-50 pt-24 md:pt-32 px-4 md:px-12 space-y-10">
  ...
  <h3 className="text-sm font-semibold text-blue-900 mb-5">
    Profile Completion
  </h3>
    ...
    <div className="absolute inset-0 flex items-center justify-center text-sm font-semibold text-blue-600">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          <StatCard title="Saved Jobs" value={savedJobs} />
        </div>
      </div>
...
function StatCard({ title, value }) {
  return (
    <div className="bg-white rounded-2xl p-6 shadow-md h-32 flex flex-col justify-center items-center">
